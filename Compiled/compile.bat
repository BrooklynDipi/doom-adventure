...
echo -------------LIGHT--------------
C:\Users\Brooklyn\Downloads\quake-leveldesign-starterkit-master\quake-leveldesign-starterkit-master\tools\ericw-tools\bin\light.exe -soft -extra4 levelblockout
